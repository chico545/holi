...
function contestantProgress() {
    ...
    for (var i = 0; i < currentCast.length; i++) {
        ...
        if (!custommode) {
            ...
            photo.setAttribute("style", "background: url("+ (currentCast[i],eliminatedCast[i]).getImg() +"); background-size: 106px 106px; background-position: center;");
...
var irisxc = new Queen("Irisxc", 11, 9, 7, 5, 5, 7, 9, "img/LMD4/IrisXCLMD4CastMug.jpg");
var lacarrera = new Queen("La carrera mami", 5, 3, 8, 6, 3, 4, 7, "img/LMD4/LaCarreraLMD4CastMug.jpg");
var leexafox = new Queen("Leexa Fox", 7, 8, 9, 9, 10, 10, 8, "img/LMD4/LeexaFoxLMD4CastMug.jpg");
var lupita = new Queen("Lupita Kush", 6, 7, 7, 6, 7, 9, 9, "img/LMD4/LupitaKushLMD4CastMug.jpg");
var morralisa = new Queen("La Morra Lisa", 6, 7, 6, 5, 5, 7, 7, "img/LMD4/LaMorraLisaLMD4CastMug.jpg");
var papercut = new Queen("Paper Cut", 9, 8, 7, 13, 7, 10, 7, "img/LMD4/PaperCutLMD4CastMug.jpg");
var rebelmork = new Queen("Rebel Mork", 7, 7, 9, 11, 9, 11, 8, "img/LMD4/RebelMorkLMD4CastMug.jpg");
